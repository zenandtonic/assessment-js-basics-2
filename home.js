...
/*
    ...
    to replace the 15 with a 10.S
*/

function changeValue(value, desc) {
    for (var i in deals) {
        if (deals[i].title == value) {
            deals[i].title = desc;
            break;
        }
    }
...
function changeValue2(value, desc) {
    for (var i in deals) {
        if (deals[i].desc == value) {
            deals[i].desc = desc;
            break;
        }
    }
...
changeValue2('   This deal lasts until the end of March! ', 'This deal lasts until the end of April!');
console.log(deals)